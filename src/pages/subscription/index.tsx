  ...
  return (
    <div className="bg-[#161616] text-white min-h-screen flex flex-col items-center py-6">
      <div className="w-full max-w-4xl p-6">
        <h2 className="text-4xl font-semibold mb-6 text-center">Our Service</h2>
        <h3 className="text-2xl font-semibold mb-6 text-center text-gray"><i>Currently we are offering all features for free</i></h3>
